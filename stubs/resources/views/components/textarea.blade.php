@props(['label' => '', 'required' => false, 'disabled' => false])
...
<div>
    ...
    <textarea @disabled($disabled)
        {{ $attributes->merge(['class' => 'border-slate-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-sm shadow-sm w-full']) }} >{{$slot}}</textarea>
